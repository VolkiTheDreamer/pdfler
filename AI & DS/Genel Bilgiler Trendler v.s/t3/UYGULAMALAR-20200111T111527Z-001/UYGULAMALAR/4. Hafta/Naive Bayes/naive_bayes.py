...
## Artık algoritmayı kullanmanın zamanı. sklearn'ün naive_bayes modülünden
# gerekli sınıfı çağırdık. GaussianNB burada Naive Bayes'in özelleşmiş hali,
# performans olarak daha iyi sonuç verdiği için onu kullanıyoruz.
from sklearn.naive_bayes import GaussianNB

## GaussianNB'den nesne oluşturup, GaussianNB sınıfına ait fit() metodunu
